<footer class="bg-gray-900 dark:bg-gray-950 text-gray-300 pt-16 pb-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
                <a href="{{ url('/') }}" class="flex items-center gap-2 mb-4">
                    ...
                    <span class="font-bold text-lg tracking-tight text-white">Food<span class="text-orange-500">Express</span></span>
                </a>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    ...
                    <li><a href="{{ url('/restaurants') }}" class="text-gray-400 hover:text-orange-500 transition">Restaurants</a></li>
                    <li><a href="{{ url('/about') }}" class="text-gray-400 hover:text-orange-500 transition">About Us</a></li>
                    <li><a href="{{ url('/contact') }}" class="text-gray-400 hover:text-orange-500 transition">Contact</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="text-gray-400 hover:text-orange-500 transition">FAQ</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-orange-500 transition">Terms of Service</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-orange-500 transition">Privacy Policy</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-orange-500 transition">Cookie Policy</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <p class="text-gray-400 text-sm mb-4">Subscribe to our newsletter for the latest deals and restaurant updates.</p>
                <form class="flex gap-2" onsubmit="event.preventDefault()">
                    <input type="email" placeholder="Your email" class="flex-1 px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition">
                    <button type="button" class="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2.5 rounded-lg text-sm font-semibold transition flex-shrink-0">
                        Subscribe
                    </button>
                </form>
            </div>
        ...
        <div class="border-t border-gray-800 dark:border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-sm text-gray-500">&copy; 2026 FoodExpress. All rights reserved.</p>
            <p class="text-sm text-gray-500">Made with <span class="text-red-500">&hearts;</span> for food lovers</p>
        </div>
    </div>
</footer>
