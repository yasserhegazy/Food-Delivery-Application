...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        <a href="<?php echo e(route('driver.deliveries.my')); ?>" class="text-gray-600 hover:text-gray-900 flex items-center gap-2">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['title' => 'Pickup Location']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Pickup Location']); ?>
                <div class="space-y-2">
                    <h3 class="text-lg font-bold text-gray-900"><?php echo e($order->restaurant->name); ?></h3>
                    <p class="text-gray-600"><?php echo e($order->restaurant->address); ?></p>
                    <p class="text-gray-600"><?php echo e($order->restaurant->city); ?></p>
                    <p class="text-gray-600"><?php echo e($order->restaurant->phone); ?></p>
                </div>
...
<?php endif; ?>
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['title' => 'Delivery Status']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Delivery Status']); ?>
                <div class="mb-6">
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['title' => 'Customer Details']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component->withAttributes(['title' => 'Customer Details']); ?>
                <div class="space-y-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-medium text-gray-900"><?php echo e($order->user->name); ?></p>
                            <a href="tel:<?php echo e($order->user->phone); ?>" class="text-sm text-orange-600 hover:text-orange-700">
                    ...
                    <div class="border-t pt-4">
                        ...
                        <a href="https://www.google.com/maps/search/?api=1&query=<?php echo e(urlencode($order->address->address_line_1 . ', ' . $order->address->city . ', ' . $order->address->zip_code)); ?>" 
                           target="_blank"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel again\food-delivery\resources\views/driver/deliveries/show.blade.php ENDPATH**/ ?>