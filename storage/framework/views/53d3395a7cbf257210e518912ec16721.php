...
<div class="relative">
    <a href="<?php echo e(route('customer.cart.index')); ?>" class="flex items-center gap-2 text-gray-700 hover:text-orange-600 transition">
...
<?php /**PATH D:\laravel again\food-delivery\resources\views/components/cart-icon.blade.php ENDPATH**/ ?>