...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['menuItem', 'size' => 'default']));
...
foreach (array_filter((['menuItem', 'size' => 'default']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div x-data="{
    ...
    async addToCart() {
        ...
        try {
            const response = await fetch('<?php echo e(route('customer.cart.add')); ?>', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    menu_item_id: <?php echo e($menuItem->id); ?>,
...
<?php /**PATH D:\laravel again\food-delivery\resources\views/components/add-to-cart-button.blade.php ENDPATH**/ ?>