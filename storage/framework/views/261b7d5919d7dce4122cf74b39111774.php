...
<?php $__env->startSection('title', 'Available Deliveries'); ?>
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="space-y-1 text-sm text-gray-600">
                                <p>
                                    <span class="font-medium">Pickup:</span> <?php echo e($order->restaurant->address); ?>, <?php echo e($order->restaurant->city); ?>
                                ...
                                <p>
                                    <span class="font-medium">Items:</span> <?php echo e($order->items->count()); ?> items
                        ...
                        <div class="flex items-center">
                            <form action="<?php echo e(route('driver.deliveries.accept', $order)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel again\food-delivery\resources\views/driver/deliveries/available.blade.php ENDPATH**/ ?>