...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="border-b border-gray-200 mb-6">
        <nav class="-mb-px flex space-x-8">
            <a href="<?php echo e(route('restaurant.orders.index', ['status' => 'pending'])); ?>"
               class="<?php echo e($status === 'pending' ? 'border-orange-500 text-orange-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?> whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                New Orders
            </a>
            <a href="<?php echo e(route('restaurant.orders.index', ['status' => 'active'])); ?>"
            ...
            <a href="<?php echo e(route('restaurant.orders.index', ['status' => 'past'])); ?>"
               class="<?php echo e($status === 'past' ? 'border-orange-500 text-orange-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?> whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                Order History
            </a>
        </nav>
    </div>
...
<?php endif; ?>
                        ...
                        <div class="flex items-center gap-3">
                            <a href="<?php echo e(route('restaurant.orders.show', $order)); ?>">
...
<?php endif; ?>
                            ...
                            <?php if($order->status === 'pending'): ?>
                                <form action="<?php echo e(route('restaurant.orders.status', $order)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
                                ...
                                <form action="<?php echo e(route('restaurant.orders.status', $order)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to reject this order?')">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel again\food-delivery\resources\views/restaurant/orders/index.blade.php ENDPATH**/ ?>