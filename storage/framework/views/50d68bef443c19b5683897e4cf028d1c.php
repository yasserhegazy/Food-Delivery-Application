...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        <a href="<?php echo e(route('restaurant.orders.index')); ?>" class="text-gray-600 hover:text-gray-900 flex items-center gap-2">
                    ...
                    <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex justify-between items-start py-3 border-b last:border-0">
                            <div class="flex-1">
                                ...
                                <?php if($item->menuItem && $item->menuItem->description): ?>
                                    <p class="text-sm text-gray-500 ml-8 mt-1"><?php echo e(Str::limit($item->menuItem->description, 50)); ?></p>
                                <?php endif; ?>
                            </div>
...
<?php endif; ?>
                    ...
                    <p class="text-sm text-gray-500">
                        Last updated: <?php echo e($order->updated_at->diffForHumans()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel again\food-delivery\resources\views/restaurant/orders/show.blade.php ENDPATH**/ ?>