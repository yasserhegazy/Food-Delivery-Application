...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'FoodDelivery')); ?> - Craving? We Deliver.</title>
                        ...
                        <?php if(Route::has('login')): ?>
                            <div class="flex items-center gap-4 ml-4">
                                <?php if(auth()->guard()->check()): ?>
                                    <a href="<?php echo e(url('/dashboard')); ?>" class="text-gray-700 hover:text-orange-500 font-medium">Dashboard</a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('login')); ?>" class="text-gray-700 hover:text-orange-500 font-medium">Log in</a>

                                    <?php if(Route::has('register')): ?>
                                        <a href="<?php echo e(route('register')); ?>" class="bg-orange-500 hover:bg-orange-600 text-white px-5 py-2.5 rounded-full font-medium transition shadow-lg shadow-orange-500/30 transform hover:-translate-y-0.5">
                                            Sign Up
                                        </a>
                                    <?php endif; ?>
                                <?php endif; ?>
            ...
            <div x-show="open" 
                ...
                <div class="px-4 pt-4 pb-6 space-y-2">
                    ...
                    <div class="border-t border-gray-100 my-2 pt-2">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="block px-4 py-3 rounded-xl text-base font-medium text-gray-700 hover:text-orange-600 hover:bg-orange-50 transition-colors">Dashboard</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="block px-4 py-3 rounded-xl text-base font-medium text-gray-700 hover:text-orange-600 hover:bg-orange-50 transition-colors">Log in</a>
                            <a href="<?php echo e(route('register')); ?>" class="block w-full text-center mt-4 px-4 py-3 rounded-xl text-base font-bold text-white bg-orange-500 hover:bg-orange-600 shadow-lg shadow-orange-500/30 transition-all transform active:scale-95">
                                Sign Up
                            </a>
                        <?php endif; ?>
                    </div>
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="text-center lg:text-left">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a href="<?php echo e(route('register')); ?>" class="inline-flex justify-center items-center px-8 py-4 border border-transparent text-lg font-medium rounded-full text-white bg-orange-500 hover:bg-orange-600 shadow-lg shadow-orange-500/30 transition transform hover:-translate-y-1">
                                Order Now
                    ...
                    <div class="relative lg:block">
                        ...
                        <img src="<?php echo e(asset('images/hero-food.png')); ?>" alt="Delicious Food Spread" class="relative rounded-3xl shadow-2xl transform hover:scale-[1.02] transition duration-500 w-full object-cover h-[500px]">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    ...
                    <div class="bg-gray-800 rounded-2xl p-8 hover:bg-gray-750 transition border border-gray-700 hover:border-orange-500 group">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center text-orange-500 font-semibold hover:text-orange-400">
                    ...
                    <div class="bg-gray-800 rounded-2xl p-8 hover:bg-gray-750 transition border border-gray-700 hover:border-orange-500 group">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center text-blue-400 font-semibold hover:text-blue-300">
        ...
        <footer class="bg-white border-t border-gray-200 pt-16 pb-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p class="text-sm text-gray-400">&copy; <?php echo e(date('Y')); ?> FoodExpress. All rights reserved.</p>
...
<?php /**PATH D:\laravel again\food-delivery\resources\views/welcome.blade.php ENDPATH**/ ?>