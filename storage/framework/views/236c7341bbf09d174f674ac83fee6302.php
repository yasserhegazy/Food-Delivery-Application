...
<?php $component->withAttributes(['class' => 'mb-6']); ?>
        <form method="GET" action="<?php echo e(route('admin.menu-items.index')); ?>" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
                <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['name' => 'search','placeholder' => 'Search menu items...','value' => ''.e(request('search')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'search','placeholder' => 'Search menu items...','value' => ''.e(request('search')).'']); ?>
...
<?php endif; ?>
            ...
            <div>
                <select name="restaurant_id" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring focus:ring-orange-200">
                    ...
                    <option value="<?php echo e($restaurant->id); ?>" <?php echo e(request('restaurant_id') == $restaurant->id ? 'selected' : ''); ?>>
            ...
            <div>
                <select name="category_id" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring focus:ring-orange-200">
                    ...
                    <option value="<?php echo e($category->id); ?>" <?php echo e(request('category_id') == $category->id ? 'selected' : ''); ?>>
                        <?php echo e($category->name); ?> (<?php echo e($category->restaurant->name); ?>)
                    </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
                <select name="available" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring focus:ring-orange-200">
                    ...
                    <option value="yes" <?php echo e(request('available') === 'yes' ? 'selected' : ''); ?>>Available</option>
                    <option value="no" <?php echo e(request('available') === 'no' ? 'selected' : ''); ?>>Unavailable</option>
                </select>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <div class="flex items-start justify-between mb-2">
                        ...
                        <span class="text-lg font-bold text-orange-600">$<?php echo e(number_format($item->price, 2)); ?></span>
                    </div>
                    <?php if($item->description): ?>
                    <p class="text-sm text-gray-600 mb-3"><?php echo e(Str::limit($item->description, 80)); ?></p>
                    <?php endif; ?>

                    <div class="space-y-2 text-sm">
                        <div class="flex items-center justify-between">
                            <span class="text-gray-500">Restaurant:</span>
                            <span class="font-medium text-gray-900"><?php echo e($item->category->restaurant->name); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-gray-500">Category:</span>
                            <span class="font-medium text-gray-900"><?php echo e($item->category->name); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-gray-500">Status:</span>
                            <?php if (isset($component)) { $__componentOriginal8c81617a70e11bcf247c4db924ab1b62 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8c81617a70e11bcf247c4db924ab1b62 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status-badge','data' => ['status' => $item->is_available]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->is_available)]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel again\food-delivery\resources\views/admin/menu-items/index.blade.php ENDPATH**/ ?>